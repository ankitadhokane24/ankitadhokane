      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {certifications.map((cert, index) => (
            <div
              key={index}
              className="bg-slate-800/40 backdrop-blur-md border border-cyan-900/50 rounded-2xl p-8 transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/40 glow-cyan flex flex-col"
            >
              {/* Icon */}
              ...
              <p className="text-cyan-400 font-medium text-center mb-1">{cert.issuer}</p>
              ...
              {cert.link && (
                <a
                  ...
                  className="mt-auto inline-block bg-cyan-600/80 hover:bg-cyan-500 text-white font-medium text-sm py-3 px-6 rounded-lg text-center transition-all duration-300 shadow-md shadow-cyan-500/30 hover:shadow-cyan-500/50"
                >
                  View Certificate
                </a>
              )}
