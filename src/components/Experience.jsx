            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className="md:w-1/2 md:text-right md:pr-12 lg:pr-16">
                  <div className="inline-block px-6 py-3 bg-cyan-900/60 rounded-full text-cyan-300 font-bold glow-cyan border border-cyan-500/40">
                    {exp.year}
                  </div>
                </div>
                ...
                {/* Content Card */}
                <div
                  className={`w-full md:w-3/5 bg-slate-800/50 backdrop-blur-md border border-cyan-900/50 rounded-2xl p-6 md:p-8 glow-cyan transition-all duration-300 hover:scale-[1.02] hover:shadow-cyan-500/40 ${
